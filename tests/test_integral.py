...
class Test(TestCase):
    ...
    def test_parabola_integral_full_n02(self):
        ...
        b = 3
        n = 7000
        self.assertRaisesRegex(ValueError, "a should be less than b", parabola_integral_full_n, a, b, n)
    ...
    def test_cubic_parabola_integral02(self):
        ...
        b = 0
        n = -100000
        self.assertRaisesRegex(ValueError, "n should be > 0", parabola_integral_full_n, a, b, n)
